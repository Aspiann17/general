...
public class MainActivity extends AppCompatActivity {
    Koneksi koneksi;
    Cursor cursor;
    ArrayList<HashMap<String, String>> arus_kas = new ArrayList<HashMap<String, String>>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.refresh).setOnClickListener(v -> show_data());
    ...
    private void show_data() {
        ...
        cursor = db.rawQuery("SELECT * FROM " + Koneksi.TABLE_NAME, null);
        cursor.moveToFirst();
        ...
        SimpleAdapter simple = new SimpleAdapter(
                ...
                new int[] {R.id.LIid, R.id.LIstatus, R.id.LIjumlah, R.id.LIketerangan, R.id.LItanggal}
        );

        list_transaksi.setAdapter(simple);
    }
